...
{
    internal class LeftSuperMarioRunningState : IMarioState
    {
        private Player mario;
        private ISprite sprite;

        public LeftSuperMarioRunningState(Player mario)
        {
            this.mario = mario;
            sprite = MarioSpriteFactory.Instance.LeftSuperMarioRunningSprite();
        }
