...
namespace Sprint_2.Constants
{
    public static class NamesOfSprites
    {
        ...
        Chiseled, Invisible, Question, BulletBlock, LeftBullet, RightBullet, Goomba, FlippedGoomba, StompedGoomba, LeftFacingKoopa, RightFacingKoopa, KoopaShell, FlippedKoopaShell, 
